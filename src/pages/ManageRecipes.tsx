...
import { Edit3, Trash2, ChevronRight, Loader2, Plus, Clock, Star, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 pb-24">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h1 className="text-4xl font-bold text-on-surface mb-2">Minhas Receitas</h1>
          <p className="text-on-surface-variant text-lg">Gerencie suas criações culinárias e compartilhe mais sabores.</p>
        </div>
        <Link 
          to="/submit" 
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1">
              <h3 className="text-lg font-bold text-primary mb-1">Modo Admin: Scraping de Receita</h3>
            ...
            <div className="flex w-full md:w-auto gap-2">
              ...
              >
                {scraping ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Scrap'}
              </button>
            </div>
          </div>
        </motion.div>
