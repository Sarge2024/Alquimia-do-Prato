            ...
            >
              ...
              {!user ? (
                ...
                >
                  ...
                  <p className="text-green-700">Seja bem-vindo, {formData.displayName}. Redirecionando você...</p>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmitProfile} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    ...
                    {/* Photo URL */}
                    <div className="relative group">
                      <label className="block text-xs font-bold text-stone-400 uppercase tracking-widest mb-2 ml-1">URL da Foto</label>
                      <div className="relative">
                        <Camera className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-stone-400 group-focus-within:text-primary transition-colors" />
                        <input
                          type="text"
                          name="photoURL"
